CREATE VIEW customer_distress_profile AS
...
SELECT customer_id, customer_full_name, branch_name, credit_score, combined_balance, total_loans, total_loan_amount,
    total_complaints, risk_score, risk_band
FROM risk_band_table
